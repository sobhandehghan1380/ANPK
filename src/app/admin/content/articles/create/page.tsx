  ...
  return (
    <div className="space-y-6 animate-fade-in text-right">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b dark:border-slate-800 pb-4">
        ...
        <Link href="/admin/content/articles" className="px-4 py-2 rounded-xl text-xs font-bold bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-400 hover:bg-slate-200 flex items-center gap-2">
            ...
            {activeSection === 'content' && (
              <div className="space-y-5">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="p-4 rounded-xl border dark:border-slate-700 border-slate-200 space-y-3">
                    <label className="text-xs font-bold dark:text-slate-300 flex items-center gap-1.5"><UploadCloud className="w-3.5 h-3.5 text-brand-500" /> تصویر شاخص (Thumbnail):</label>
                    {thumbnailPreview && (
                    ...
                    <input type="file" accept="image/*" onChange={handleThumbnailChange}
                      className="w-full text-xs file:bg-brand-50 file:text-brand-500 file:border-0 file:rounded-lg file:px-2 file:py-1 file:font-bold file:mr-2 file:cursor-pointer" />
                  </div>
                  <div className="p-4 rounded-xl border dark:border-slate-700 border-slate-200 space-y-3">
                    <label className="text-xs font-bold dark:text-slate-300 flex items-center gap-1.5"><UploadCloud className="w-3.5 h-3.5 text-brand-500" /> تصویر هدر (Cover):</label>
                    {coverPreview && (
                      <div className="relative w-full h-24 rounded-lg overflow-hidden group">
            ...
            {activeSection === 'og' && (
              <div className="space-y-5">
                ...
                <div className="space-y-4 p-5 glass-card rounded-2xl border dark:border-slate-800">
                  ...
                  <div className="space-y-2">
                    <label className="text-[10px] font-bold text-slate-400 flex items-center gap-1"><UploadCloud className="w-3 h-3"/> تصویر OG (1200×630 پیکسل):</label>
