...
export default function HubLayout({ children }: { children: React.ReactNode }) {
  ...
  const tabs = [{"path": "/portal/finance/invoices", "label": "فاکتورهای مالی", "icon": "FileText"}, {"path": "/portal/finance/wallet", "label": "شارژ کیف\u200cپول", "icon": "Wallet"}];
      ...
      <div className="bg-slate-50 dark:bg-slate-900 rounded-3xl p-6 border dark:border-slate-800 border-slate-200">
        <div className="flex flex-col sm:flex-row gap-4 justify-between items-start sm:items-center">
          <div className="space-y-1 text-right w-full">
            ...
            <p className="text-xs text-slate-500 dark:text-slate-400">مدیریت اعتبارات ریالی، شارژ حساب و صورتحساب‌های چندردیفه.</p>
          </div>
        </div>
